    ...
    <View className="mb-5">
      ...
      <View 
        className={`flex-row items-center h-14 px-4 rounded-2xl bg-white border ${
          focusedField === fieldKey ? 'border-indigo-500 shadow-sm' : 'border-slate-100'
        }`}
        style={focusedField === fieldKey ? { elevation: 2 } : {}}
      >
        <Ionicons name={icon} size={20} color={focusedField === fieldKey ? "#6366f1" : "#94a3b8"} />
        <TextInput
          value={value}
          ...
          <Animated.View style={animatedContentStyle}>
            ...
            <View className="items-center mb-6">
              <Text className="text-slate-500 text-sm">
                Don't have an account? <Link href="/signup" className="text-indigo-600 font-bold">Create one</Link>
              </Text>
            </View>
          </Animated.View>
        </ScrollView>
